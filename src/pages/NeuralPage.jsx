...
const ONDAS = [
  {
    ...
    descricao: "Sono profundo, recuperação",
  },
  {
    key: "eegTheta",
    label: "Theta",
    ...
    valor: 18,
    cor: "var(--accent-cyan)",
    descricao: "Relaxamento, sonolência",
  },
  {
    key: "eegAlpha",
    label: "Alpha",
    ...
    descricao: "Relaxamento alerta (dominante)",
  },
  {
    key: "eegBeta",
    label: "Beta",
    ...
    descricao: "Cognição, concentração",
  },
  {
    key: "eegGamma",
    label: "Gamma",
    ...
    valor: 8,
    cor: "var(--accent-red)",
    descricao: "Processamento avançado",
  },
];
...
export default function NeuralPage() {
  ...
  const [nirsData, setNirsData] = useState(
    Array.from({ length: 20 }, (_, i) => ({
      t: i,
      hbo2: 65 + Math.round(Math.random() * 8),
      hb: 18 + Math.round(Math.random() * 5),
    })),
  );
    ...
    const t = setInterval(() => {
      ...
      setNirsData((prev) => [
        ...prev.slice(1),
        {
          ...
          hbo2:
            63 +
            Math.round(Math.sin(Date.now() / 2000) * 5 + Math.random() * 4),
  ...
  return (
    <div>
      ...
      <div className="row g-3 mb-4">
        {[
          {
            label: "Oxig. Cerebral (fNIRS)",
            value: "68%",
            ok: true,
            color: "var(--accent-purple)",
          },
          {
            label: "Fluxo Sanguíneo Cerebral",
            value: "62%",
            ok: true,
            color: "var(--accent-blue)",
          },
          {
            label: "Índice Alfa/Beta",
            value: "1.4",
            ok: true,
            color: "var(--accent-green)",
          },
          {
            label: "Risco Neural IA",
            value: "38%",
            ok: true,
          ...
          <div className="col-6 col-md-3" key={m.label}>
            ...
            >
              ...
              <div className="metric-status badge-normal mt-2">
      ...
      <div className="section-header">
        Bandas EEG — Distribuição de Frequências
      </div>
      <div className="row g-3 mb-4">
        {ONDAS.map((o) => (
          <div className="col-6 col-md" key={o.key}>
            <div className="card-dark h-100 text-center">
              ...
              <div className="risk-bar">
                <div
                  className="risk-fill"
                  style={{ width: `${o.valor}%`, background: o.cor }}
                />
              </div>
              <div
                style={{
      ...
      <div className="row g-3 mb-4">
        ...
        <div className="col-12 col-lg-7">
          <div className="card-dark h-100">
            ...
            >
              <span>
                <span style={{ color: "var(--accent-violet)" }}>─</span> Delta
              </span>
              <span>
                <span style={{ color: "var(--accent-green)" }}>─</span> Alpha
              </span>
              <span>
                <span style={{ color: "var(--accent-orange)" }}>─</span> Beta
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="col-12">
          <div className="card-dark">
            <div className="section-header">
              fNIRS — Oxigenação Cerebral Regional
            </div>
            <div
              style={{
                fontSize: 12,
            ...
            >
              HbO₂ (oxihemoglobina) e Hb (desoxihemoglobina) — região
              pré-frontal
            </div>
